...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "VYAPERI X — AI Sales Intelligence & Autonomous Voice Fleet" },
      {
        name: "description",
        content:
          "VYAPERI X discovers high-intent prospects from LinkedIn, X, directories and web sources, enriches them automatically, and deploys multilingual AI voice agents for end-to-end autonomous sales.",
      },
      {
        property: "og:title",
        content: "VYAPERI X — AI Sales Intelligence & Autonomous Voice Fleet",
      },
      {
        property: "og:description",
        content:
          "Discover · Enrich · Qualify · Call. One unified platform that replaces manual prospecting with AI-powered lead discovery and multilingual voice outreach.",
      },
    ],
  }),
  component: Index,
...
> = {
  ...
  gu: {
    title: "Gujarati Voice Protocol — Bharat Patel (Patel Textiles, Surat)",
    agent: "Dhruv",
    lead: "Bharat Patel",
    ...
    lines: [
      [
        "AGENT",
        "નમસ્તે Bharat ભાઈ! હું વ્યાપારી X થી ધ્રુવ વાત કરું છું. આપની કંપની માટે Cloud ERP અને Inventory Automation સોલ્યુશન અંગે વાત કરવી હતી — શું આપ 2 મિનિટ ફાળવી શકશો?",
      ],
      [
        "PROSPECT",
        "હા ધ્રુવ ભાઈ, બોલો. અમે સુરત અને અમદાવાદના 4 ગોડાઉન માટે સેન્ટ્રલાઇઝ્ડ સોફ્ટવેર શોધી રહ્યા છીએ.",
      ],
      [
        "AGENT",
        "ઉત્તમ! અમારું સોલ્યુશન GST બિલિંગ, રિયલ-ટાઇમ સ્ટોક અને મલ્ટી-લોકેશન સિંક પૂરી રીતે ઓટોમેટ કરે છે. શું બુધવારે સવારે 10:30 વાગ્યે એક લાઈવ ડેમો રાખીએ?",
      ],
      ["PROSPECT", "હા, બુધવારે ૧૦:૩૦ અનુકૂળ રહેશે. ઇમેઇલ પર લિંક મોકલી આપજો."],
    ],
  },
  en: {
    title: "English Enterprise Protocol — Daniel Whitfield (Orbit Retail UK)",
    agent: "Arjun",
    ...
    lines: [
      [
        "AGENT",
        "Hi Daniel, calling from VYAPERI X regarding your recent post on headless commerce replatforming — is the vendor selection currently underway?",
      ],
        ...
        <div className="mx-auto grid max-w-[1400px] gap-10 px-4 py-12 lg:grid-cols-[1.05fr_1fr] lg:px-8 lg:py-20">
          <div className="min-w-0 space-y-6">
            ...
            <ScrollReveal variant="fade-up" delay={250}>
              <p className="label-mono text-violet text-sm font-bold">सुनो · समझो · सौदा करो</p>
