...
export function FileUploadZone({
  ...
  // FIX 3: Return type uses React.ReactElement (not JSX.Element) to avoid
  // TSX parser ambiguity. Uses FileIcon (renamed lucide icon) not the DOM File.
  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div
        ...
        className={`relative border-2 border-dashed p-6 transition-all duration-200 cursor-pointer flex flex-col items-center justify-center text-center ${isDragging
